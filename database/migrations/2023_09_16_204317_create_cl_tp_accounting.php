...
return new class extends Migration
{
    ...
    {
        Schema::create('cl_tp_accounting', function (Blueprint $table) {
            ...
            $table->integer('rem_trips')->default(0);
        ...
        $table_name = 'cl_tp_accounting';
        Schema::table($table_name, function (Blueprint $table) {
            $table->index('atek_id', 'index_cl_tp_accounting__atek_id');
            $table->index('engraved_id', 'index_cl_tp_accounting__engraved_id');
            $table->index('pax_mobile', 'index_cl_tp_accounting__pax_mobile');
            $table->index('pass_id', 'index_cl_tp_accounting__pass_id');
        });
    }
    ...
    {
        Schema::dropIfExists('cl_tp_accounting');
    }
};
