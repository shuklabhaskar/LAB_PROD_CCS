...
return new class extends Migration
{
    ...
    {
        Schema::create('cl_indra_rep', function (Blueprint $table) {
        ...
        $table_name = 'cl_indra_rep';
        Schema::table($table_name, function (Blueprint $table) {
            $table->index('atek_id', 'index_cl_indra_rep__atek_id');
            $table->index('engraved_id', 'index_cl_indra_rep__engraved_id');
            $table->index('chip_id', 'index_cl_indra_rep__chip_id');
            $table->index('pax_mobile', 'index_cl_indra_rep__pax_mobile');
        });
    }
    ...
    {
        Schema::dropIfExists('cl_indra_rep');
    }
};
