    ...
    <div class="container-fluid p-0">
        ...
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>CREATE</strong> PASS</h3>
            </div>
        </div>

        <div class="row">
            <div class="col-md-12">
                <form @submit.prevent="storePass">
                    <div class="accordion mb-4" id="accordionPass">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input  type="number" class="form-control" maxlength="4" v-model="form.pass_id" placeholder="Pass ID"/>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <select class="form-control form-select" v-on:change="updateText" v-model="form.product_type_id">
                                                        <option value="null">Select Product Type</option>
                                                        <option v-for="ProductType in ProductTypes" :value="ProductType.product_type_id">{{ProductType.product_name.toUpperCase()}}</option>
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <div class="text-danger" v-if="errors.company_id">{{errors.company_id }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <div class="text-danger" v-if="errors.status">{{ errors.status }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4 col-md-4">
                                                    ...
                                                    <div class="text-danger" v-if="errors.fare_table_id">{{errors.fare_table_id }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <div class="text-danger" v-if="errors.start_date">{{errors.start_date }}
                                                    </div>
                                                </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        aria-controls="flush-collapseTwo">PASS PENALTY DETAILS
                                </button>
                            </h2>
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                 aria-labelledby="flush-headingTwo" data-bs-parent="#accordionPass">
                                <div class="accordion-body">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-3" id="over_travel_pen">
                                                    <label class="form-label">Over Travelling Penalty</label>
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text">₹</span>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                 aria-labelledby="flush-headingThree" data-bs-parent="#accordionPass">
                                <div class="accordion-body">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-3">
                                                    ...
                                                    <select v-model="form.is_test" class="form-control form-select" name="test_id">
                                                        <option selected value="null">Is Test</option>
                                                ...
                                                <div class="mb-3 col-md-3" id="entry_validity_period">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" min="0" v-model="form.entry_validity_period" class="form-control"/><span class="input-group-text">Min</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-3" id="return_validity_period">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" min="0" v-model="form.return_validity_period" class="form-control"/><span class="input-group-text">Min</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-3" id="pass_validity_period">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" min="0" v-model="form.pass_validity_period" class="form-control"/><span class="input-group-text">Days</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-3" id="grace_period">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="number" min="0" v-model="form.grace_period" class="form-control"/><span class="input-group-text">Days</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4" id="min_sv_topup_amt">
                                                    ...
                                                    <div class="input-group mb-3"><span class="input-group-text">₹</span>
                                                        <input type="text" class="form-control" v-model="form.min_sv_topup_amt">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4" id="sv_step_topup_amt">
                                                    ...
                                                    <div class="input-group mb-3"><span class="input-group-text">₹</span>
                                                        <input type="text" class="form-control" v-model="form.sv_step_topup_amt">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4" id="min_sv_entry_bal">
                                                    ...
                                                    <div class="input-group mb-3"><span class="input-group-text">₹</span>
                                                        <input type="text" class="form-control"  v-model="form.min_sv_entry_bal">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-4" id="max_sv_bal">
                                                    ...
                                                    <div class="input-group mb-3"><span class="input-group-text">₹</span>
                                                        <input type="text" class="form-control" v-model="form.max_sv_bal">
                                                    </div>
                                                </div>
                    ...
                    <div class="row mb-xl-3">
                        ...
                        <!--BACK BUTTON-->
                        <div class="col-auto d-none d-sm-block">
                            <Link :href="'/pass'" class="btn btn-outline-primary"><font-awesome-icon icon="fa-solid fa-backward"/> Back
                            </Link>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content bg-light">
                                    <div class="modal-body m-3 text-center">
                                        ...
                                        <h3 class="m-2">
                                            <span>Are you sure! do you want to create this Pass ?</span></h3>
        ...
        data() {
            return {
                form: useForm({
                    ...
                    start_date: null,
                    end_date: null,
                    same_stn_over_time_limit: null,
                    same_stn_over_time_pen: null,
                    same_stn_over_time_max_pen: null,
                    other_stn_over_time_limit: null,
                    other_stn_over_time_pen: null,
                    other_stn_over_time_max_pen: null,
                    over_travel_pen: null,
                    entry_mismatch_limit: null,
                    entry_mismatch_same_time_pen: null,
                    entry_mismatch_no_exit_pen: null,
                    exit_mismatch_pen: null,
                    entry_exit_control: null,
                    entry_validity_period: null,
                    return_validity_period: null,
                    pass_validity_period: null,
                    grace_period: null,
                    trip_count: null,
                    ...
                    refund_permit: null,
                    refund_charges: null,
                    min_sv_topup_amt: null,
                    sv_step_topup_amt: null,
                    min_sv_entry_bal: null,
                    max_sv_bal: null,
                    is_test: false,
                })
            }
