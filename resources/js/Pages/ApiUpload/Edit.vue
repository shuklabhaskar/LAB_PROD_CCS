    ...
    <div class="container-fluid p-0">
        ...
        <div class="card col-9 d-flex">
            ...
            <div class="card-body">
                ...
                <!--FORM FOR API INPUTS-->
                <form @submit.prevent="updateApiRoute">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                            <label class="form-label" for="api_name">API Name <span class="text-danger"> *</span></label>
                            <input id="api_name" v-model="form.api_name" name="api_name" class="form-control" placeholder="Enter Api Name"/>
                            <div class="text-danger" v-if="errors.api_name">{{ errors.api_name}}</div>
                        </div>

                        <!--API ROUTE-->
                        <div class="mb-3 col-md-4">
                            <label class="form-label" for="api_route">Api Route <span class="text-danger"> *</span></label>
                            <input id="api_route" v-model="form.api_route"  name="api_route" class="form-control" placeholder="Enter Api Route"/>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input id="api_description" v-model="form.api_description" name="api_route" class="form-control" placeholder="Enter Api Description"/>
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <select class="form-control form-select" v-model="form.api_request_type">
...
export default {
    ...
    data() {
        return {
            form: useForm({
                ...
                api_route: this.api.api_route,
                api_description: this.api.api_description,
                api_request_type: this.api.api_request_type,
                product_type_id: this.api.product_type_id
            })
        }
    },
    ...
    methods: {
        updateApiRoute() {
            this.form.post('/api/endPoint/update/'+this.api.ms_api_route_id)
        }
    }
}
</script>
