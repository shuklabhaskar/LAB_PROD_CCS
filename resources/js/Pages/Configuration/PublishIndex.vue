            ...
            <div class="row mb-2 mb-xl-3">
                ...
                <div class="row">
                    ...
                    <div class="col-4 d-flex justify-content-end">
                        ...
                        <input type="text"
                               class="form-control flatpickr-minimum input-sm me-2 flex-grow-1"
                               v-model="form.activation_time"
                               placeholder="Enter Activation Time"
                               style="max-width: 450px;"/>
                        <span class="text-danger">{{ activationTimeError }}</span>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="exampleModalLabel">Select Equipment for
                                            publish </h4>
                                    ...
                                    <div class="modal-body">
                                        <table id="example" class="table table-striped" style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <th>IP</th>
                                                <th>STATUS</th>
                                                <th><input disabled class="form-check-input" type="checkbox"
                        ...
                        <div class="card-body">
                            ...
                            <table id="example2" class="table table-striped" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select disabled id="Eq_config_version" class="form-control"
                                                name="config_version" v-model="form.Equipment.version">
                                            <option value="-1">Select Equipment Version</option>
                                            <option v-for="Eq in EqConfig" :value="Eq.config_version">
                                                {{ Eq.config_version }}
                                            </option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <input class="form-check-input" type="checkbox"
                                               v-model="form.Equipment.isSelected" id="Eq_version_checkbox">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Fare Config</td>
                                    <td>
                                        <select id="config_version" class="form-control" name="config_version"
                                                v-model="form.Fare.version">
                                            <option value="-1">Select Fare Version</option>
                                            <option v-for="Fare in FareConfig" :value="Fare.config_version">
                                                {{ Fare.config_version }}
                                            </option>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <input class="form-check-input" type="checkbox" v-model="form.Fare.isSelected"
                                               :value="2" id="fare_version_checkbox">
                                        <input hidden class="form-check-input" type="checkbox"
                                               v-model="form.Fare.config_id" :value="2" id="fare_config_id">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select disabled id="stn_config_version" class="form-control"
                                            ...
                                            <option value="-1">Select Station Version</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="pass_config_version" class="form-control" name="config_version"
                                            ...
                                            <option value="-1">Select Pass Version</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select disabled id="user_config_version" class="form-control"
                                            ...
                                            <option value="1">Select User Version</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="card_blacklist_config_version" class="form-control"
                                                name="config_version" v-model="form.CardBlacklist.version">
                                            <option value="-1">Select Blacklist Version</option>
                                            <option v-for="CardBl in CardBlConfig" :value="CardBl.config_version">
                                                {{ CardBl.config_version }}
                                            </option>
                                        </select>
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox"
                                               v-model="form.CardBlacklist.isSelected"
                                               id="cardBlacklist_version_checkbox">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select disabled id="acq_config_version" class="form-control"
                                                v-model="form.Acquirer.version">
                                            <option value="1">Select Acquirer Version</option>
                                            <option v-for="AcqParamConfig in AcqParamConfig"
                                                    :value="AcqParamConfig.config_version">
                                                {{ AcqParamConfig.config_version }}
                                            </option>
                                        </select>
                                    </td>
                                    <td>
                                        <input class="form-check-input" type="checkbox"
                                               v-model="form.Acquirer.isSelected" :value="2" id="acq_params_checkbox">
                                        <input hidden class="form-check-input" type="checkbox"
                                               v-model="form.Acquirer.config_id" :value="2" id="acq_params_config_id">
                                    </td>
