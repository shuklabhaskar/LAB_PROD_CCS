<template>
    ...
    <div class="row mb-2 mb-xl-3">
        <div class="col-auto d-none d-sm-block">
            <h3><strong>EDIT </strong>OPERATORS PRIVILEGE</h3>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-2">
                        ...
                        <select  disabled class="form-control form-select" v-model="form.operator_id">
                            <option  value="null">Select Operator</option>
                            <option  v-for="data in Operators" :key="data.operator_id" :value="data.operator_id">
                                {{ data.operator_name }}
                            </option>
                        </select>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="editOperatorPrivilege" class="table table-striped" style="width:100%">
...
export default defineComponent({
    ...
    mounted() {
        ...
        $("#editOperatorPrivilege").DataTable({
            responsive: true,
            "paging": true,
            "ordering": false,
            scrollY: 400,
            ...
            initComplete: function () {
                this.api().columns([3]).every(function (d) {
                    var column = this;
                    var theadname = $("#editOperatorPrivilege th").eq([d]).text(); /*USE THIS TO SPECIFY TABLE NAME*/
    ...
    data() {
        return {
            form: useForm({
                selected: this.selectedApi.map(api => api.ms_api_route_id) || [],
                grant_all_api: false,
                isSelected: false,
                operator_id: this.operatorId.operator_id,
                sjt: null,
                rjt: null,
                tp: null,
                sv: null,
    ...
    methods: {
        ...
        storeOperatorsPrivilege() {
            this.form.post('/operator/privilege/edit/'+this.operatorId.operator_id);
        }
    }
})
</script>
